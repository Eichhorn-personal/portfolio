...
export function EmailButton() {
    ...
    return (
        ...
        <a data-tooltip-id="button-email" data-tooltip-content="mailto:ceichhorn@gmail.com">
...
export function GithubButton(prop) {
...
export function LinkedInButton(prop) {
...
export function ResumeButton(prop) {

    console.log('ResumeButton.js received prop ',prop);

    console.log(prop.myFile);
    ...
    return (
        ...
        <div>
            ...
            >
                ...
                {showModal && <ResumeModal isVisible={showModal} onClose={handleClose} myFile={prop.myFile} />}
